...
import 'package:first_app/widgets/SlideView.dart';
...
class NewsListPage extends StatelessWidget {
  ...
  NewsListPage() {
    ...
    for (int i = 0; i < 3; i++) {
      ...
      // 轮播图的详情URL
      map['detailUrl'] =
      'https://www.oschina.net/news/103081/linux-2016-2018';
      // 轮播图的图片URL
      map['imgUrl'] =
  ...
  // 渲染列表item
  Widget renderRow(ctx,i) {
    // i为0时渲染轮播图
    if (i == 0) {
      return new Container(
        height: 180.0,
        child: new SlideView(slideData, indicator),
      );
    }
    // i > 0时
    i -= 1;
    ...
    var timeRow = new Row(
      children: <Widget>[
        ...
        // 这是时间文本
        new Padding(
          padding: const EdgeInsets.fromLTRB(2, 0.0, 0.0, 0.0),
          child: new Text(
            itemData['timeStr'],
            style: subtitleStyle,
          ),
